...
[It is reported that PHENIX in version 1.18.2-3874 is not supported while version 1.19.2 works well, so please install the latest version of PHENIX. When error message related to PHENIX appears in cryoID, changing the PHENIX version may solve the problem. Also don't hesitate to ask Qibo Xu for help via xuqibo@ucla.edu. (eddited @10/11/2022)]
